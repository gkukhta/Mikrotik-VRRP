...
/interface vrrp add interface=ether2 name=vrrp1 priority=100 vrid=220 version=3 \
sync-connection-tracking=yes remote-address=192.168.88.2
/ip address add address=192.168.88.1/24 interface=vrrp1
/tool netwatch add host=192.168.122.1 interval=3s \
up-script="/interface vrrp set [find name=vrrp1] priority=100" \
